...
function kopa_shortcode_icon_click(shortcode, textarea){
    ...
    switch(shortcode){
        ...
        case 'button':
            ...
            break;
        case 'alert':
            textarea.insertAtCaret('[alert type="e.g. warning, danger, success, info" title=""]', '[/alert]');
            break;
        case 'tabs':
            var tabs_string = '[tabs tab1="Tab 1" tab2="Tab 2" tab3="Tab 3"]';
            tabs_string += '[tab id="tab1"]Tab content 1[/tab]';
            tabs_string += '[tab id="tab2"]Tab content 2[/tab]';
            tabs_string += '[tab id="tab3"]Tab content 3[/tab]';
            tabs_string += '[/tabs]';
