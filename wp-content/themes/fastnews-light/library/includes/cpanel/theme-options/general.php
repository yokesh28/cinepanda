<div class="kopa-content-box tab-content tab-content-1" id="tab-general">
    ...
    <div class="kopa-box-body">
        <div class="kopa-element-box kopa-theme-options">
            ...
            <input type="text" value="<?php echo intval(get_option('kopa_theme_options_logo_margin_top')); ?>" id="kopa_theme_options_logo_margin_top" name="kopa_theme_options_logo_margin_top" class=" kopa-short-input">
            ...
            <input type="text" value="<?php echo intval(get_option('kopa_theme_options_logo_margin_left')); ?>" id="kopa_theme_options_logo_margin_left" name="kopa_theme_options_logo_margin_left" class=" kopa-short-input">
            <label class="kopa-label"><?php _e('px', kopa_get_domain()); ?></label>

            <span class="kopa-spacer"></span>

            <label class="kopa-label"><?php _e('Right margin:', kopa_get_domain()); ?> </label>
            <input type="text" value="<?php echo intval(get_option('kopa_theme_options_logo_margin_right')); ?>" id="kopa_theme_options_logo_margin_right" name="kopa_theme_options_logo_margin_right" class=" kopa-short-input">
            <label class="kopa-label"><?php _e('px', kopa_get_domain()); ?></label>

            <span class="kopa-spacer"></span>

            <label class="kopa-label"><?php _e('Bottom margin:', kopa_get_domain()); ?> </label>
            <input type="text" value="<?php echo intval(get_option('kopa_theme_options_logo_margin_bottom')); ?>" id="kopa_theme_options_logo_margin_bottom" name="kopa_theme_options_logo_margin_bottom" class=" kopa-short-input">
            <label class="kopa-label"><?php _e('px', kopa_get_domain()); ?></label>
        ...
        ?>
        <div class="kopa-element-box kopa-theme-options">
            <span class="kopa-component-title"><?php _e('Footer menu logo', kopa_get_domain()); ?></span>

            <p class="kopa-desc"><?php _e('Upload your own logo.', kopa_get_domain()); ?></p>    
            <div class="clearfix">
                <input class="left" type="text" value="<?php echo esc_url(get_option('kopa_theme_options_footer_logo')); ?>" id="kopa_theme_options_footer_logo" name="kopa_theme_options_footer_logo">
                <button class="left btn btn-success upload_image_button" alt="kopa_theme_options_footer_logo"><?php echo KopaIcon::getIcon('arrow-circle-up'); ?><?php _e('Upload', kopa_get_domain()); ?></button>
            </div>
        </div><!--kopa-element-box-->
        ...
        <div class="kopa-element-box kopa-theme-options">
            ...
            <div class="clearfix">
                <input class="left" type="text" value="<?php echo esc_url(get_option('kopa_theme_options_apple_ipad_retina_icon_url')); ?>" id="kopa_theme_options_apple_ipad_retina_icon_url" name="kopa_theme_options_apple_ipad_retina_icon_url">
    ...
    <div class="kopa-box-body">
        ...
        <div class="kopa-element-box kopa-theme-options">
            ...
            <input type="number" min="2" value="<?php echo get_option('kopa_theme_options_headline_posts_number', 10); ?>" id="kopa_theme_options_headline_posts_number" name="kopa_theme_options_headline_posts_number">
        </div>
    </div>
    ...
    <div class="kopa-box-body">
        ...
        <div class="kopa-element-box kopa-theme-options">
            ...
            <textarea class="" rows="6" id="kopa_setting_copyrights" name="kopa_theme_options_copyright"><?php echo htmlspecialchars_decode(stripslashes(get_option('kopa_theme_options_copyright', __('Copyright &copy; 2013 . All Rights Reserved. Designed by kopatheme.com.', kopa_get_domain())))); ?></textarea>
        </div><!--kopa-element-box-->
