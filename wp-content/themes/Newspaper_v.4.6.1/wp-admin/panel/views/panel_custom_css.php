...
<?php echo td_panel_generator::box_start('Advanced CSS', false); ?>
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            <div class="td-display-inline-block">
                <img src="<?php echo get_template_directory_uri() . '/wp-admin/images/panel/resp-desktop.png';?>">
            </div>
            <div class="td-display-inline-block">
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            <div class="td-display-inline-block">
                <img src="<?php echo get_template_directory_uri() . '/wp-admin/images/panel/resp-ipado.png';?>">
            </div>
            <div class="td-display-inline-block">
                <span class="td-box-title">IPAD LANDSCAPE</span>
                <p>1019 - 1199px</p>
            </div>
        </div>
        <div class="td-box-control-full">
            ...
            echo td_panel_generator::textarea(array(
                'ds' => 'td_option',
                'option_id' => 'tds_responsive_css_ipad_landscape',
            ));
            ?>
        </div>
    </div>
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            <div class="td-display-inline-block">
                <img src="<?php echo get_template_directory_uri() . '/wp-admin/images/panel/resp-ipadv.png';?>">
            </div>
            <div class="td-display-inline-block">
    ...
    <div class="td-box-row">
        <div class="td-box-description">
            <div class="td-display-inline-block">
                <img src="<?php echo get_template_directory_uri() . '/wp-admin/images/panel/resp-phone.png';?>">
            </div>
            <div class="td-display-inline-block">
