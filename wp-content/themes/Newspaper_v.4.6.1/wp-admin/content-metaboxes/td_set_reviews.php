<div class="my_meta_control td-not-portfolio td-not-home">
        ...
        <div class="my_meta_control td-not-home">
            ...
            <?php $mb->the_group_open(); ?>
                ...
                <select name="<?php $mb->the_name(); ?>">
                                ...
                                <option value="1"<?php $mb->the_select_state('no'); ?>>0 stars</option>
                </select>
    ...
    <div class="review_desc">
        ...
        <p class="td_help_section">
            ...
            <textarea style="width: 500px; height: 100px;" type="text" name="<?php $mb->the_name(); ?>"><?php $mb->the_value(); ?></textarea>
        </p>
    </div>
