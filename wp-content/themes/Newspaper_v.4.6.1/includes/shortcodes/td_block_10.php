...
class td_block_10 extends td_block {
    ...
    function __construct() {
        $this->block_id = 10;
        add_shortcode('td_block10', array($this, 'render'));
    }
    ...
    function render($atts){
        ...
        $buffy .= '<div class="td_block_wrap ' . $this->block_id . '">';
    ...
    function get_map () {
        ...
        return array(
            "name" => __("Block 10", TD_THEME_NAME),
            "base" => "td_block10",
            "class" => "td_block10",
            "controls" => "full",
            "category" => __('Blocks', TD_THEME_NAME),
            'icon' => 'icon-pagebuilder-block10',
...
td_global_blocks::add_instance('Block 10', new td_block_10());